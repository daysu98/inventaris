...
<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'" class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0" @click.outside="sidebarToggle = false">
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a class="flex gap-3 justify-center items-center" href="{{ route('welcome') }}">
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <!-- Sidebar Menu -->
        <nav class="mt-3 px-4 py-4 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            <ul class="mb-6 flex flex-col gap-1.5">
                <!-- Menu Item Dashboard -->
                <li>
                    <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="{{ route('dashboard') }}"
            ...
            <div>
                ...
                <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2 uppercase">Data Utama</h3>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <!-- Menu Item - Barang End -->
                </ul>
            </div>
            <!-- Data Utama Group End -->

            <!-- Transaksi Group -->
            <div>
                <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2 uppercase">Transaksi</h3>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4" href="#"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current" width="18" height="19" viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M12 0L8 4h2v4h4V4h2M1 2v2h2l3.6 7.6L5.2 14c-.1.3-.2.6-.2 1c0 1.1.9 2 2 2h12v-2H7.4c-.1 0-.2-.1-.2-.2v-.1l.9-1.7h7.4c.7 0 1.4-.4 1.7-1l3.9-7l-1.7-1l-3.9 7h-7L4.3 2M7 18c-1.1 0-2 .9-2 2s.9 2 2 2s2-.9 2-2s-.9-2-2-2m10 0c-1.1 0-2 .9-2 2s.9 2 2 2s2-.9 2-2s-.9-2-2-2" />
                            </svg>

                            Barang Keluar
                        </a>
                    </li>
                    <!-- Menu Item Barang Keluar End-->
                </ul>
            </div>
            <!-- Transaksi Group End -->
        </nav>
        ...
        <!-- Promo Box -->
        <div class="mx-auto mb-10 w-full max-w-60 rounded-sm bg-boxdark px-4 py-6 text-center shadow-default dark:bg-black">
            <p class="text-xs"> © 2024 - Developed by <a href="https://www.instagram.com/_daysuu" target="_blank" class="text-primary">@_daysuu</a></p>
        </div>
        <!-- Promo Box -->
    </div>
</aside>
