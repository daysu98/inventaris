            ...
            <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                    ...
                    @if (session()->has('message'))
                        <!-- Alerts Item -->
                        <div class="mb-6 flex items-center w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] p-7 shadow-md dark:bg-opacity-30">
                    ...
                    @error('message')
                        <!-- Alerts Item -->
                        <div class="mb-6 flex items-center w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] p-7 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30">
                    ...
                    <form method="POST" action="{{ route('loginProcess') }}">
                        ...
                        <div class="mt-6 text-center">
                            <p class="font-medium">
                                ...
                                <a href="{{ route('registerView') }}" class="text-primary">Sign Up</a>
                            </p>
                        </div>
                    </form>
                </div>
